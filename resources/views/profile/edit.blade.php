...
<div class="content">
  <div class="row" style="display: flex; justify-content:space-evenly;">
    <div class="card col-xl-6" style="margin-bottom: 30px;">
            ...
            <div class="col-sm-7">
              <div class="fileinput fileinput-new text-center" data-provides="fileinput">
                ...
                <div>
                  ...
                  <button id="upload_button" class="btn btn-primary " type="submit" name="submit"> <i class="fa fa-save"></i>&nbsp;Save</button>
                </div>
              </div>
            </div>
            <div class="col-sm-5">
              <div class="mb-2" style="display: flex; align-items:center; font-size: 15px;">
                <i class="material-icons" style="font-size: 25px;">perm_identity</i> &nbsp;&nbsp; <label class="label_title_2" style="display:block; overflow:hidden;">{{$userData->name}}</label>
              </div>
              ...
              <div style="display: flex; align-items:center; font-size: 15px;">
                <i class="material-icons" style="font-size: 25px;">email</i>&nbsp;&nbsp;<label class="label_title_2" style="display:block; overflow:hidden;">{{$userData->email}}</label>
              </div>
            </div>
          </div>
        </form>
    ...
    <div class="card col-xl-5" style="margin-bottom: 30px;">
      <div class="card-header card-header-icon card-header-rose">
        <div class="card-icon">
          <i class="material-icons">perm_identity</i>
        </div>
