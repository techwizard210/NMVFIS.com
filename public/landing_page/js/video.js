(function(global, factory) {
    ...
    var AudioTrackList = function(_TrackList) {
        ...
        function AudioTrackList() {
            ...
            list = (_this = possibleConstructorReturn(this, _TrackList.call(this, tracks, list)),
            _this);
    ...
    var AudioTrack = function(_Track) {
        ...
        function AudioTrack() {
            ...
            var track = (_this = possibleConstructorReturn(this, _Track.call(this, settings)),
            _this);
            var enabled = false;
            if (IS_IE8) {
    ...
    videojs.addLanguage = function(code, data) {
        ...
        videojs.options.languages = mergeOptions(videojs.options.languages, (_mergeOptions = {},
