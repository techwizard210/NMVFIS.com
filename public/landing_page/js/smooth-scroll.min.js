...
!function(t, e) {
    ...
    n.animateScroll = function(e, n, o) {
        var a = c(a || r, o || {})
          , u = d(e ? e.getAttribute("data-options") : null);
        a = c(a, u),
        n = "#" + i(n.substr(1));
        var p, m, b, v = document.querySelector(n), g = document.querySelector("[data-scroll-header]"), O = null === g ? 0 : g.offsetHeight + g.offsetTop, y = t.pageYOffset, I = f(v, O, parseInt(a.offset, 10)), S = I - y, w = l(), A = 0;
        h(n, a.updateURL);
        var Q = function(o, r, c) {
            var u = t.pageYOffset;
            (o == r || u == r || t.innerHeight + u >= w) && (clearInterval(c),
            v.focus(),
            a.callbackAfter(e, n))
        }
          , C = function() {
            A += 16,
            m = A / parseInt(a.speed, 10),
            m = m > 1 ? 1 : m,
            b = y + S * s(a.easing, m),
    ...
    var p = function(t) {
        ...
        o && "a" === o.tagName.toLowerCase() && (t.preventDefault(),
        n.animateScroll(o, o.hash, e, t))
    };
    return n.destroy = function() {
        e && (document.removeEventListener("click", p, !1),
        e = null)
    }
    ,
    n.init = function(t) {
