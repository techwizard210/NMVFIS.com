!function(t, e) {
    ...
    , function(t, e) {
        ...
        function l() {
            return z || (z = $.createCanvas().getContext("2d")),
            z
        }
        function h(t, e) {
            if (t) {
        ...
        }, E = Object.prototype.toString, N = Array.prototype, H = N.forEach, j = N.filter, V = N.slice, X = N.map, G = N.reduce, Y = "__ec_primitive__", U = "_ec_", Z = 4;
        F.prototype = {
            constructor: F,
            get: function(t) {
                return this[U + t]
            ...
            each: function(t, e) {
                void 0 !== e && (t = x(t, e));
                for (var r in this)
                    this.hasOwnProperty(r) && t(this[r], r.slice(Z))
            },
        ...
        n.prototype = {
            ...
            brush: function(t, e) {
                ...
                this.__dirty) {
                    ...
                    this._fillGradient = r.getGradient(t, o, p)),
                    u && (p = p || this.getBoundingRect(),
                    this._strokeGradient = r.getGradient(t, s, p))
                }
                ...
                n.setScale(x[0], x[1]),
                this.__dirtyPath || g && !m && i ? (n.beginPath(t),
                g && !m && (n.setLineDash(g),
            ...
            contain: function(t, e) {
                ...
                n.contain(t, e)) {
                    ...
                    if (i.hasStroke()) {
                        ...
                        if (l > 1e-10 && (i.hasFill() || (o = Math.max(o, this.strokeContainThreshold)),
            ...
            attrKV: function(t, e) {
                ...
                this.__dirtyPath = !0,
                this._rect = null) : i.prototype.attrKV.call(this, t, e)
            },
        ...
        n.prototype = {
            ...
            calculateTransform: function(t) {
                var e = this
                  ...
                  , n = t.height / e.height
                  , i = a.create();
                return a.translate(i, i, [-e.x, -e.y]),
                a.scale(i, i, [r, n]),
        ...
        function m(t, e) {
            ...
            for (var g = 0; g < o.length; g++) {
                for (var v = o[g], m = 0, y = 0, _ = 0; _ < v.tokens.length; _++) {
                    ...
                    if (T && (k += T[0] + T[2]),
                    w.height = k,
                    w.lineHeight = I(S.textLineHeight, e.textLineHeight, k),
                    w.textAlign = S && S.textAlign || e.textAlign,
                    w.textVerticalAlign = S && S.textVerticalAlign || "middle",
                    null != p && s + w.lineHeight > p)
                        return {
                            lines: [],
                            width: 0,
                            height: 0
                    ...
                    if ("string" == typeof O && "%" === O.charAt(O.length - 1))
                        ...
                        if (D) {
                            ...
                            var L = S.textBackgroundColor
                              , B = L && L.image;
                            B && (B = b.findExistImage(B),
                            b.isImageReady(B) && (O = Math.max(O, B.width * k / B.height)))
                        }
                        var F = T ? T[1] + T[3] : 0;
                        O += F;
                        var R = null != d ? d - y : null;
                        null != R && R < O && (!D || R < F ? (w.text = "",
                        w.textWidth = O = 0) : (w.text = u(w.text, R - F, M, f.ellipsis, {
                            minChar: f.minChar
                        }),
                        w.textWidth = A.getWidth(w.text, M),
                        O = w.textWidth + F))
            ...
            c && (r.outerWidth += c[1] + c[3],
            r.outerHeight += c[0] + c[2]);
        ...
        _.prototype = {
            ...
            closePath: function() {
                ...
                var t = this._ctx
                  , e = this._x0
                  , r = this._y0;
                return t && (this._needsDash() && this._dashedLineTo(e, r),
                t.closePath()),
                this._xi = e,
                this._yi = r,
                this
            ...
            _dashedLineTo: function(t, e) {
                var r, n, i = this._dashSum, a = this._dashOffset, o = this._lineDash, s = this._ctx, l = this._xi, h = this._yi, u = t - l, c = e - h, f = m(u * u + c * c), g = l, v = h, x = o.length;
                for (u /= f,
                c /= f,
                a < 0 && (a = i + a),
                a %= i,
                g -= a * u,
                v -= a * c; u > 0 && g <= t || u < 0 && g >= t || 0 == u && (c > 0 && v <= e || c < 0 && v >= e); )
                    n = this._dashIdx,
                    r = o[n],
                    g += u * r,
                    v += c * r,
            ...
            _dashedBezierTo: function(t, e, r, i, a, o) {
                var s, l, h, u, c, f = this._dashSum, d = this._dashOffset, p = this._lineDash, g = this._ctx, v = this._xi, x = this._yi, y = n.cubicAt, _ = 0, w = this._dashIdx, b = p.length, S = 0;
                for (d < 0 && (d = f + d),
                d %= f,
                s = 0; s < 1; s += .1)
            ...
            toStatic: function() {
                ...
                y && (this.data = new Float32Array(t)))
            },
            getBoundingRect: function() {
            ...
            rebuildPath: function(t) {
                for (var e, r, n, i, a, o, s = this.data, h = this._ux, u = this._uy, c = this._len, f = 0; f < c; ) {
                    ...
                    case l.L:
                        a = s[f++],
                        o = s[f++],
                        (x(a - n) > h || x(o - i) > u || f === c - 1) && (t.lineTo(a, o),
                        n = a,
                        i = o);
                        break;
                    case l.C:
                    ...
                    case l.A:
                        ...
                        t.scale(1 / P, 1 / k),
                        t.rotate(-S),
                        t.translate(-p, -m)) : t.arc(p, m, M, w, I, 1 - T),
                        1 == f && (e = g(w) * y + p,
                        r = v(w) * _ + m),
                        n = g(I) * y + p,
                        i = v(I) * _ + m;
        ...
        o.createOrUpdateImage = function(t, e, r, i, o) {
            if (t) {
                if ("string" == typeof t) {
                    ...
                    return l ? (e = l.image,
                    !s(e) && l.pending.push(h)) : (!e && (e = new Image),
                    e.onload = n,
                    a.put(t, e.__cachedImgObj = {
                        image: e,
                        pending: [h]
                    }),
    ...
    , function(t, e, r) {
        ...
        function o(t, e, r, n, i) {
            ...
            for (var M = 0; M < r.lines.length; M++) {
                for (var P, k = r.lines[M], C = k.tokens, I = C.length, A = k.lineHeight, O = k.width, D = 0, L = b, B = T, F = I - 1; D < I && (P = C[D],
                !P.textAlign || "left" === P.textAlign); )
                    l(t, e, P, n, A, S, L, "left"),
                    O -= P.width,
                    L += P.width,
                    D++;
                for (; F >= 0 && (P = C[F],
                "right" === P.textAlign); )
                    l(t, e, P, n, A, S, B, "right"),
                    O -= P.width,
                    B -= P.width,
                    F--;
                for (L += (a - (L - b) - (T - B) - O) / 2; D <= F; )
                    P = C[D],
        ...
        function s(t, e, r, n, i) {
            if (r && e.textRotation) {
                var a = e.textOrigin;
                "center" === a ? (n = r.width / 2 + r.x,
                i = r.height / 2 + r.y) : a && (n = a[0] + r.x,
                i = a[1] + r.y),
                t.translate(n, i),
        ...
        function l(t, e, r, n, i, a, o, s) {
            ...
            var p = r.textPadding;
            p && (o = g(o, s, p),
            f -= r.height / 2 - p[2] - r.textHeight / 2),
            ...
            m && (d(e, "lineWidth", y),
            d(e, "strokeStyle", m),
            e.strokeText(r.text, o, f)),
            x && (d(e, "fillStyle", x),
            e.fillText(r.text, o, f))
        }
        function h(t) {
        ...
        function u(t, e, r, n, i, a, o) {
            var s = r.textBackgroundColor
              ...
              , h = r.textBorderColor
              , u = m.isString(s);
            if (d(e, "shadowBlur", r.textBoxShadowBlur || 0),
            d(e, "shadowColor", r.textBoxShadowColor || "transparent"),
            d(e, "shadowOffsetX", r.textBoxShadowOffsetX || 0),
            d(e, "shadowOffsetY", r.textBoxShadowOffsetY || 0),
            u || l && h) {
                e.beginPath();
    ...
    , function(t, e, r) {
        ...
        function o(t) {
            t.__isHover || (a(t),
            t.useHoverLayer ? t.__zr && t.__zr.addHover(t, t.__hoverStl) : (t.style.extendFrom(t.__hoverStl),
            t.dirty(!1),
            t.z2 += 1),
            t.__isHover = !0)
        }
        ...
        function v(t, e, r) {
            ...
            var a, o = e.ecModel, s = o && o.option.textStyle, l = m(e);
            if (l) {
                a = {};
                for (var h in l)
        ...
        function x(t, e, r, n, i) {
            ...
            a || (null == o && (o = r.color),
            null == s && (s = r.textBorderColor),
            null == l && (l = r.textBorderWidth),
            null == o && n.checkInside && n.checkInside(e, t.textPosition) && (o = "#fff",
            null == s && (s = n.defaultTextColor,
            null == l && (l = 2))),
            null == o && (o = n.defaultTextColor)),
            t.textFill = o,
            t.textStroke = s,
            t.textLineWidth = l,
            ...
            i && n.disableBox || (t.textBackgroundColor = y(e.getShallow("backgroundColor"), n),
            t.textPadding = e.getShallow("padding"),
            t.textBorderColor = y(e.getShallow("borderColor"), n),
        ...
        function _(t, e, r, n, i, a) {
            ...
            if (o) {
                ...
                l > 0 ? e.animateTo(r, l, u || 0, h, a, !!a) : (e.stopAnimation(),
                e.attr(r),
                a && a())
            } else
                e.stopAnimation(),
        ...
        L.makePath = function(t, e, r, n) {
            ...
            if (r) {
                ...
                if ("center" === n) {
                    var s, l = r.height * o;
                    l <= r.width ? s = r.height : (l = r.width,
                    s = l / o);
                    var h = r.x + r.width / 2
                      , u = r.y + r.height / 2;
                    r.x = h - l / 2,
        ...
        L.setText = function(t, e, r) {
            ...
            r === !1 ? n.forMerge = !0 : (n.defaultTextColor = n.autoColor = r,
            n.checkInside = g),
            v(t, e, n),
            t.host && t.host.dirty && t.host.dirty(!1)
        }
        ...
        L.getTransform = function(t, e) {
            for (var r = M.identity([]); t && t !== e; )
                M.mul(r, t.getLocalTransform(), r),
                t = t.parent;
            return r
        }
        ,
        ...
        L.groupTransition = function(t, e, r, n) {
            ...
            function a(t) {
                ...
                return t.shape && (e.shape = w.extend({}, t.shape)),
                e
            }
            if (t && e) {
                var o = i(t);
        ...
        L.createIcon = function(t, e, r) {
            ...
            t)
                ...
                w.defaults(n, r),
                new L.Image(e)) : L.makePath(t.replace("path://", ""), e, r, "center")
        }
        ,
        t.exports = L
    }
    , function(t, e, r) {
        ...
        o.getPercentWithPrecision = function(t, e, r) {
            ...
            for (var i = Math.pow(10, r), o = a.map(t, function(t) {
                ...
                for (var c = Number.NEGATIVE_INFINITY, f = null, d = 0, p = u.length; d < p; ++d)
                    u[d] > c && (c = u[d],
                    f = d);
                ++l[f],
                u[f] = 0,
        ...
        ,
        o.nice = function(t, e) {
            var r, n = i(t), a = Math.pow(10, n), o = t / a;
    ...
    , function(t, e) {
        t.exports = {
            buildPath: function(t, e) {
                ...
                h < 0 && (s += h,
                h = -h),
                "number" == typeof u ? r = n = i = a = u : u instanceof Array ? 1 === u.length ? r = n = i = a = u[0] : 2 === u.length ? (r = i = u[0],
                n = a = u[1]) : 3 === u.length ? (r = u[0],
                n = a = u[1],
                i = u[2]) : (r = u[0],
                n = u[1],
                i = u[2],
    ...
    , function(t, e, r) {
        ...
        h.decomposeTransform = function() {
            if (this.transform) {
                var t = this.parent
                  , e = this.transform;
                t && t.transform && (i.mul(u, t.invTransform, e),
                e = u);
    ...
    , function(t, e, r) {
                ...
                if ("#" !== n.charAt(0)) {
                    ...
                    if (i !== -1 && a + 1 === n.length) {
                        ...
                        case "rgba":
                            ...
                            d = s(h.pop());
                        case "rgb":
                            return 3 !== h.length ? void u(e, 0, 0, 0, 1) : (u(e, o(h[0]), o(h[1]), o(h[2]), d),
                            f(t, e),
                            e);
                        case "hsla":
                            return 4 !== h.length ? void u(e, 0, 0, 0, 1) : (h[3] = s(h[3]),
                            p(h, e),
                            f(t, e),
                            e);
                        case "hsl":
                            return 3 !== h.length ? void u(e, 0, 0, 0, 1) : (p(h, e),
                            f(t, e),
                            e);
                        default:
                            return
        ...
        function g(t) {
            if (t) {
                var e, r, n = t[0] / 255, i = t[1] / 255, a = t[2] / 255, o = Math.min(n, i, a), s = Math.max(n, i, a), l = s - o, h = (s + o) / 2;
                if (0 === l)
                    e = 0,
                    r = 0;
                else {
        ...
        function v(t, e) {
            ...
            if (r) {
                for (var n = 0; n < 3; n++)
                    e < 0 ? r[n] = r[n] * (1 - e) | 0 : r[n] = (255 - r[n]) * e + r[n] | 0;
    ...
    , function(t, e, r) {
        ...
        t.exports = i.graphic.extendShape({
            ...
            buildPath: function(t, e) {
                for (var r = Math.max(2 * Math.ceil(2 * e.radius / e.waveLength * 4), 8); e.phase < 2 * -Math.PI; )
                    e.phase += 2 * Math.PI;
                for (; e.phase > 0; )
                    e.phase -= 2 * Math.PI;
                ...
                e.inverse ? (t.lineTo(o + a, e.cy - e.radius),
                t.lineTo(a, e.cy - e.radius),
                t.lineTo(a, e.waterLevel)) : (t.lineTo(o + a, e.cy + e.radius),
                t.lineTo(a, e.cy + e.radius),
    ...
    , function(t, e, r) {
        ...
        n.extendChartView({
            ...
            render: function(t, e, r) {
                function i(t, e) {
                    if (A) {
                        if (0 === A.indexOf("path://")) {
                            ...
                            var l = e ? 0 : k - o / 2
                              , h = e ? 0 : C - s / 2;
                            return r = n.graphic.makePath(A.slice(7), {}, new n.graphic.BoundingRect(l,h,o,s)),
                ...
                S && (w = t.get("outline.borderDistance"),
                b = o(t.get("outline.itemStyle.borderWidth"), _));
                var T, M, P, k = o(v[0], x), C = o(v[1], y), I = !1, A = t.get("shape");
                if ("container" === A ? (I = !0,
                T = [x / 2, y / 2],
                M = [T[0] - b / 2, T[1] - b / 2],
                P = [o(w, x), o(w, y)],
                m = [M[0] - P[0], M[1] - P[1]]) : (T = o(m, _) / 2,
                M = T - b / 2,
                P = o(w, _),
                m = M - P),
                S) {
    ...
    , function(t, e, r) {
        function n(t, e, r) {
            function n(t, e, r) {
                c[e] ? t.otherDims[e] = r : (t.coordDim = e,
                t.coordDimIndex = r,
                v.set(e, !0))
            }
            function o(t, e, r) {
            ...
            for (var _ = 0; _ < x; _++) {
                ...
                null != b && null == g.get(b) && (S.name = S.tooltipName = b,
                g.set(b, _)),
            ...
            s(t, function(t, e) {
                ...
                if (!c.length)
                    for (var f = 0; f < (i && i.length || 1); f++) {
                        for (; T < m.length && null != m[T].coordDim; )
                            T++;
                        T < m.length && c.push(T++)
                    }
                s(c, function(e, a) {
            ...
            for (var M = r.extraPrefix || "value", P = 0; P < x; P++) {
                var S = m[P] = m[P] || {}
                  , k = S.coordDim;
                null == k && (S.coordDim = o(M, v, r.extraFromZero),
                S.coordDimIndex = 0,
                S.isExtraCoord = !0),
    ...
    , function(t, e, r) {
        ...
        function i(t, e, r) {
            for (var n = 0; n < e.length && (!e[n] || (t = t && "object" == typeof t ? t[e[n]] : null,
            null != t)); n++)
                ;
    ...
    , function(t, e, r) {
        ...
        u.converDataValue = function(t, e) {
            var r = e && e.type;
            return "ordinal" === r ? t : ("time" === r && "number" != typeof t && null != t && "-" !== t && (t = +a.parseDate(t)),
            null == t || "" === t ? NaN : +t)
        }
        ,
        ...
        u.dataFormatMixin = {
            ...
            getFormattedLabel: function(t, e, r, n, a) {
                ...
                return "function" == typeof h ? (l.status = e,
                h(l)) : "string" == typeof h ? i.formatTpl(h, l) : void 0
            },
        ...
        u.makeIdAndName = function(t) {
            ...
            l(t, function(t, r) {
                var n = t.exist
                  ...
                  , a = t.keyInfo;
                if (h(i)) {
                    if (a.name = null != i.name ? i.name + "" : n ? n.name : "\0-",
                    n)
                        a.id = n.id;
                    else if (null != i.id)
                        a.id = i.id + "";
    ...
    , function(t, e, r) {
        ...
        var n = r(14)
          ...
          , c = {};
        for (var f in h)
            h.hasOwnProperty(f) && (c[f] = new h[f]);
        var d = n.extendShape({
            type: "symbol",
            shape: {
                symbolType: "",
            ...
            buildPath: function(t, e, r) {
                var n = e.symbolType
                  , i = c[n];
                "none" !== e.symbolType && (i || (n = "rect",
                i = c[n]),
                u[n](e.x, e.y, e.width, e.height, i.shape),
          ...
          , p = function(t) {
            if ("image" !== this.type) {
                var e = this.style
                  , r = this.shape;
                r && "line" === r.symbolType ? e.stroke = t : this.__isEmptyBrush ? (e.stroke = t,
    ...
    , function(t, e, r) {
        ...
        function g(t, e, r, n, i, f) {
            var g = t._getter
              ...
              , w = n.length;
            if (w) {
                var b, S = n[0].value, T = y(S), M = !1, P = !1, k = T ? p(n) : 0;
                n.sort(function(t, e) {
                ...
                if (f || !O) {
                    for (var F = I[w - 1], D = 0; D < w - 1; D++)
                        T ? l(I[D], F, k) : !isNaN(I[D]) || isNaN(F) || P || M || (I[D] = F);
                    T && l(g(t._target, i), F, k);
                    var R, z, q, W, E, N, H = 0, j = 0;
                    if (M)
                        var V = [0, 0, 0, 0];
                    var X = function(t, e) {
                        var r;
                        ...
                        if (0 !== n)
                            ...
                            _)
                                ...
                                N = I[r > w - 3 ? w - 1 : r + 2],
                                T)
                                    u(q, W, E, N, z, z * z, z * z * z, g(t, i), k);
                                else {
                                    var l;
                                    if (M)
                                        l = u(q, W, E, N, z, z * z, z * z * z, V, 1),
                                        l = d(V);
                                    else {
                                        if (P)
                                            return o(W, E, z);
    ...
    , function(t, e) {
        var r = {
            ...
            elasticInOut: function(t) {
                ...
                return 0 === t ? 0 : 1 === t ? 1 : (!r || r < 1 ? (r = 1,
                e = n / 4) : e = n * Math.asin(1 / r) / (2 * Math.PI),
                (t *= 2) < 1 ? -.5 * (r * Math.pow(2, 10 * (t -= 1)) * Math.sin((t - e) * (2 * Math.PI) / n)) : r * Math.pow(2, -10 * (t -= 1)) * Math.sin((t - e) * (2 * Math.PI) / n) * .5 + 1)
            },
            backIn: function(t) {
                var e = 1.70158;
                return t * t * ((e + 1) * t - e)
        ...
        t.exports = {
            containStroke: function(t, e, r, i, a, o, s, l, h, u, c) {
                if (0 === h)
                    return !1;
                var f = h;
                if (c > e + f && c > i + f && c > o + f && c > l + f || c < e - f && c < i - f && c < o - f && c < l - f || u > t + f && u > r + f && u > a + f && u > s + f || u < t - f && u < r - f && u < a - f && u < s - f)
                    return !1;
    ...
    , function(t, e, r) {
        ...
        function a(t, e, r, n, a, o, s, l, h, u) {
            ...
            for (var f, d, p = 0, v = -1, m = 0; m < c; m++) {
                ...
                b < h || (v < 0 && (v = g.cubicExtrema(e, n, o, l, w),
                w[1] < w[0] && v > 1 && i(),
                f = g.cubicAt(e, n, o, l, w[0]),
                v > 1 && (d = g.cubicAt(e, n, o, l, w[1]))),
                p += 2 == v ? x < w[0] ? f < e ? y : -y : x < w[1] ? d < f ? y : -y : l < d ? y : -y : x < w[0] ? f < e ? y : -y : l < f ? y : -y)
            }
            return p
        }
            ...
            for (var c = 0, f = 0; f < 2; f++) {
                ...
                if (d + t > o) {
                    var g = Math.atan2(s, d)
                      , u = a ? 1 : -1;
                    g < 0 && (g = x + g),
                    (g >= n && g <= i || g + x >= n && g + x <= i) && (g > Math.PI / 2 && g < 1.5 * Math.PI && (u = -u),
                    c += u)
                }
            }
            return c
        ...
        function l(t, e, r, i, l) {
            for (var u = 0, p = 0, g = 0, x = 0, y = 0, _ = 0; _ < t.length; ) {
                var w = t[_++];
                switch (w === h.M && _ > 1 && (r || (u += v(p, g, x, y, i, l))),
                1 == _ && (p = t[_],
                g = t[_ + 1],
                x = p,
                y = g),
                ...
                case h.L:
                    if (r) {
                        if (m(p, g, t[_], t[_ + 1], e, i, l))
                            return !0
                    } else
                        u += v(p, g, t[_], t[_ + 1], i, l) || 0;
                    p = t[_++],
                    g = t[_++];
                    break;
                case h.C:
                    if (r) {
                        if (c.containStroke(p, g, t[_++], t[_++], t[_++], t[_++], t[_], t[_ + 1], e, i, l))
                            return !0
                    } else
                        u += a(p, g, t[_++], t[_++], t[_++], t[_++], t[_], t[_ + 1], i, l) || 0;
                    p = t[_++],
                    g = t[_++];
                    break;
                case h.Q:
                    if (r) {
                        if (f.containStroke(p, g, t[_++], t[_++], t[_], t[_ + 1], e, i, l))
                            return !0
                    } else
                        u += o(p, g, t[_++], t[_++], t[_], t[_ + 1], i, l) || 0;
                    p = t[_++],
                    g = t[_++];
                    break;
                case h.A:
                    ...
                    1 - t[_++])
                      , I = Math.cos(P) * T + b
                      , A = Math.sin(P) * M + S;
                    _ > 1 ? u += v(p, g, I, A, i, l) : (x = I,
                    y = A);
                    var O = (i - b) * M / T + b;
                    if (r) {
                        if (d.containStroke(b, S, M, P, P + k, C, e, O, l))
                            return !0
                    } else
                        u += s(b, S, M, P, P + k, C, O, l);
                    p = Math.cos(P + k) * T + b,
                    g = Math.sin(P + k) * M + S;
                    break;
                case h.R:
        ...
        t.exports = {
            containStroke: function(t, e, r, i, a, o, s, l, h) {
                if (0 === s)
                    return !1;
                var u = s;
                if (h > e + u && h > i + u && h > o + u || h < e - u && h < i - u && h < o - u || l > t + u && l > r + u && l > a + u || l < t - u && l < r - u && l < a - u)
                    return !1;
        ...
        o.prototype = {
            ...
            remove: function(t) {
                var e = this.__zr
                  ...
                  , i = this._children
                  , a = n.indexOf(i, t);
                return a < 0 ? this : (i.splice(a, 1),
                t.parent = null,
                r && (r.delFromStorage(t),
    ...
    , function(t, e, r) {
        ...
        a.fromPoints = function(t, e, r) {
            if (0 !== t.length) {
                var n, i = t[0], a = i[0], l = i[0], h = i[1], u = i[1];
        ...
        a.fromCubic = function(t, e, r, n, a, l, h, u, c, f) {
            var d, v = i.cubicExtrema, m = i.cubicAt, x = v(t, r, a, h, p);
            for (c[0] = 1 / 0,
            c[1] = 1 / 0,
            f[0] = -(1 / 0),
            f[1] = -(1 / 0),
            ...
            brush: function(t, e) {
                ...
                if (i && s.isImageReady(i)) {
                    var a = r.x || 0
                      ...
                      , h = r.height
                      , u = i.width / i.height;
                    if (null == l && null != h ? l = h * u : null == h && null != l ? h = l / u : null == l && null == h && (l = i.width,
                    h = i.height),
                    this.setTransform(t),
                    r.sWidth && r.sHeight) {
                        var c = r.sx || 0
    ...
    , function(t, e, r) {
        ...
        s.prototype = {
            ...
            bind: function(t, e, r) {
                ...
                if ((a || n.fill !== i.fill) && (t.fillStyle = n.fill),
                (a || n.stroke !== i.stroke) && (t.strokeStyle = n.stroke),
                (a || n.opacity !== i.opacity) && (t.globalAlpha = null == n.opacity ? 1 : n.opacity),
                (a || n.blend !== i.blend) && (t.globalCompositeOperation = n.blend || "source-over"),
                this.hasStroke()) {
                    var u = n.lineWidth;
            ...
            extendFrom: function(t, e) {
                if (t)
                    for (var r in t)
                        !t.hasOwnProperty(r) || e !== !0 && (e === !1 ? this.hasOwnProperty(r) : null == t[r]) || (this[r] = t[r])
            },
            set: function(t, e) {
            ...
            getGradient: function(t, e, r) {
                for (var a = "radial" === e.type ? i : n, o = a(t, e, r), s = e.colorStops, l = 0; l < s.length; l++)
    ...
    , function(t, e, r) {
        ...
        s.prototype = {
            ...
            brush: function(t, e) {
                ...
                null != n && (n += ""),
                r.bind(t, this, e),
                o.needDrawText(n, r) && (this.setTransform(t),
                o.renderText(this, t, n, r),
                this.restoreTransform(t))
            },
            getBoundingRect: function() {
                var t = this.style;
                if (this.__dirty && o.normalizeTextStyle(t, !0),
                !this._rect) {
                    var e = t.text;
                    null != e ? e += "" : e = "";
                    ...
                    if (r.x += t.x || 0,
                    r.y += t.y || 0,
                    o.getStroke(t.textStroke, t.textLineWidth)) {
    ...
    , function(t, e, r) {
        ...
        t.exports = function(t, e) {
            ...
            l = l < r ? r : l;
            for (var s = 0; s < l; s++) {
                var h, u, c, f = s / (l - 1) * (e ? r : r - 1), d = Math.floor(f), p = f - d, g = t[d % r];
                e ? (h = t[(d - 1 + r) % r],
                u = t[(d + 1) % r],
                c = t[(d + 2) % r]) : (h = t[0 === d ? d : d - 1],
                u = t[d > r - 2 ? r - 1 : d + 1],
                c = t[d > r - 3 ? r - 1 : d + 2]);
                var v = p * p
                  , m = p * v;
        ...
        o.prototype = {
            ...
            drawRectText: function(t, e) {
                ...
                n.needDrawText(i, r)) {
                    ...
                    r.transformText ? this.setTransform(t) : o && (a.copy(e),
                    a.applyTransform(o),
                    e = a),
        ...
        t.exports = r(2).extend({
            ...
            buildPath: function(t, e) {
                var r = e.x1
                  ...
                  , d = e.percent;
                0 !== d && (t.moveTo(r, n),
                null == u || null == c ? (d < 1 && (o(r, l, i, d, f),
                l = f[1],
                i = f[2],
                o(n, h, a, d, f),
                h = f[1],
                a = f[2]),
                t.quadraticCurveTo(l, h, i, a)) : (d < 1 && (s(r, l, u, i, d, f),
                l = f[1],
                u = f[2],
                i = f[3],
                s(n, h, c, a, d, f),
            ...
            _animateToShallow: function(t, e, r, n, a) {
                ...
                for (var h in r)
                    if (r.hasOwnProperty(h))
                        if (null != e[h])
                            s(r[h]) && !i.isArrayLike(r[h]) ? this._animateToShallow(t ? t + "." + h : h, e[h], r[h], n, a) : (o[h] = r[h],
                            l++);
                        else if (null != r[h])
                            if (t) {
                                var u = {};
    ...
    , function(t, e, r) {
        ...
        function i(t) {
            ...
            var i, a = r.split("|"), o = 0, l = 0, u = new s, c = s.CMD;
    ...
    , function(t, e, r) {
        function n(t, e) {
            var r, n, a, u, c, f, d = t.data, p = i.M, g = i.C, v = i.L, m = i.R, x = i.A, y = i.Q;
            for (a = 0,
            u = 0; a < d.length; ) {
                switch (r = d[a++],
                u = a,
