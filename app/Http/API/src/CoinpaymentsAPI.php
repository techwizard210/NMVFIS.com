...
class CoinpaymentsAPI
{
     ...
     * @throws Exception
     */
    public function CreateSimpleTransaction($amount, $currency, $buyer_email, $ipn_url)
    {
        $fields = [
            'amount' => $amount,
            'currency1' => 'USD',
            ...
            'ipn_url' => $ipn_url,
            'success_url' => 'http://localhost:8000/Ipn.php',
            'cancel_url' => 'http://localhost:8000/Ipn.php',
        ];
